<template>
  <div class="HelloWorld">
    ...
    <div class="the_story">
      <ul>
        <li v-for="(v,i) in the_story" :key="i">{{v}}</li>
      </ul>
    </div>
    <div class="img_box">
    ...
    <div class="the_story">
      <ul>
        <li v-for="(v,i) in other" :key="i">{{v}}</li>
      </ul>
    </div>
    <div class="img_box">
    ...
    <div class="the_bottom">
      <div class="bot_img">
        <img v-for="(v,i) in botimg" :key="i" :src="v" @click="bot_img_click(i)"/>
      </div>
      <p>Copyright 2019-2020 小付同学 All Rights Reserved</p>
      <p>粤ICP备19054851号-1</p>
    </div>
  </div>
</template>
  ...
  data () {
    return {
      ...
      botimg:[
        ...
        require('../../assets/img/social_sina.svg')
      ],
      head_poem: [],
      the_story:[],
      other:[],
  ...
  methods:{
    bot_img_click(el){
      switch(el){
        ...
        case 2:window.open('https://weibo.com/u/6096309423?topnav=1&wvr=6&topsug=1&is_all=1'); break;
        default:window.open('https://github.com/The-Dark-Knight6');
      }
    },
    getdata(){
      ...
      this.$http.get(url).then(res=>{
        ...
        this.the_story = my.story;
        this.other = my.other;
        this.last_poem = my.last_poem;
      })
    }
  }
}
